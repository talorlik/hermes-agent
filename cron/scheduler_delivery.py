    ...
    try:
        ...
        try:
            ...
            try:
                ...
                # Build the coroutine INSIDE the submitted callable: if submit itself raises
                # (interpreter-shutdown race), no coroutine object exists to leak as a
                # "was never awaited" RuntimeWarning.
                return pool.submit(
                    contextvars.copy_context().run, lambda: asyncio.run(_send())
